`OAuth` is an open standard protocol that allows third-party applications to access a user's resources (e.g., data) on a resource owner's behalf without exposing the user's credentials. 
